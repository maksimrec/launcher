...
public class OptionsPanel extends JDialog {
	...
	public OptionsPanel(Frame parent) {
		...
		JLabel label = new JLabel("Обновление", 0);
		...
		final JButton forceButton = new JButton(
				"Выполнить обновление принудительно!");
		forceButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ae) {
				GameUpdater.forceUpdate = true;
				forceButton.setText("Клиент будет обновлен при запуске!");
				forceButton.setEnabled(false);
			}
		});
		labelPanel.add(new JLabel("Обновить клиент: ", 4));
